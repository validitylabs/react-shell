...
const SW_PATH = `/pwa-service-worker.js`;
...
//             return;
//         }
//         // this will trigger the `controller change` event
...
// function listenForWaitingServiceWorker(registration: any, callback: any) {
//     function awaitStateChange() {
//         registration.installing.addEventListener(`statechange`, function (this: any) {
...
// function onRegistration(registration: any) {
